...
(library Library_1
	...
	(compDef "SN74LVC2G04DBVR" (originalName "SN74LVC2G04DBVR") (compHeader (numPins 6) (numParts 1) (refDesPrefix IC)
		...
		(compPin "6" (pinName "1Y") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "5" (pinName "VCC") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "4" (pinName "2Y") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "http://www.ti.com/lit/gpn/sn74lvc2g04")
		(attr "Height" "1.45 mm")
	)
